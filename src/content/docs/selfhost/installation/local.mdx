...
3. Set Up Environment Variables
   ...
   Rename `.env.example` to `.env and` and fill in the required information.
...
5. For development purposes, you can use the following command to start the bot with nodemon:
